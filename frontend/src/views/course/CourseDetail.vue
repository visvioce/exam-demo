<template>
  <div class="course-detail base-detail-page">
    ...
    <el-card class="exams-card">
      ...
      <el-table :data="exams" v-loading="examsLoading" stripe table-layout="auto" :fit="true" class="detail-table">
      ...
      <el-empty v-if="!examsLoading && exams.length === 0" description="暂无考试" />
    </el-card>
